...
class lab_comu_l(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab_comu_l")
        ...
        self._amp_range = qtgui.Range(0, 5, 0.5, 0, 200)
...
def main(top_block_cls=lab_comu_l, options=None):
